            ...
            <div className="app-container lg:w-[75%] max-w-[1200px] w-auto mx-6 md:mx-12 lg:mx-auto">
               <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-[48px]">
                  <div className="mt-auto lg:mt-[120px]">
                    <h1 className={`${styles["hero-headline"]} text-[38px] md:text-[60px] lg:text-[73px] text-start font-nm-medium font-medium leading-[41px] lg:leading-[65px] text-black w-auto tracking-normal`}>
